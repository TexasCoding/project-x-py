...
async def test_trading_suite_create_with_direct_credentials():
    """TradingSuite.create accepts username/api_key instead of env vars."""
            ...
            with patch(
                ...
                with patch(
                    ...
                    suite = await TradingSuite.create(
                        ...
                        api_key="direct_key",  # pragma: allowlist secret
...
async def test_trading_suite_create_requires_direct_credentials_together():
    """Partial direct credentials fail before client construction."""
