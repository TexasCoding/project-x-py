...
def create_client(username: Optional[str] = None, api_key: Optional[str] = None, config: Optional[ProjectXConfig] = None) -> ProjectX:
    """
...
def create_realtime_client(jwt_token: str, account_id: str, config: Optional[ProjectXConfig] = None) -> ProjectXRealtimeClient:
    """
