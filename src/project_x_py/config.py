...
class ConfigManager:
    ...
    def save_config(self, config: ProjectXConfig, file_path: Optional[Union[str, Path]] = None):
        """
    ...
    def validate_config(self, config: ProjectXConfig) -> bool:
        ...
        for url_field in required_urls:
            ...
            elif not (url.startswith('http://') or url.startswith('https://') or url.startswith('wss://')):
...
def check_environment() -> Dict[str, Any]:
    ...
    env_vars = [
        'PROJECTX_API_URL', 'PROJECTX_REALTIME_URL', 'PROJECTX_USER_HUB_URL',
        'PROJECTX_MARKET_HUB_URL', 'PROJECTX_TIMEZONE', 'PROJECTX_TIMEOUT_SECONDS',
        'PROJECTX_RETRY_ATTEMPTS', 'PROJECTX_RETRY_DELAY_SECONDS',
        'PROJECTX_REQUESTS_PER_MINUTE', 'PROJECTX_BURST_LIMIT'
    ]
